            ...
            {isForgotPassword ? (
              ...
              <form onSubmit={handleForgotPassword} className="space-y-5" noValidate>
                ...
                <div className="text-center">
                  <button type="button" onClick={() => { setIsForgotPassword(false); setErrors({}); setTouched({}); }}
                    className="text-sm text-muted-foreground hover:text-[hsl(var(--electric-cyan))] transition-colors">
                    <span className="font-medium text-[hsl(var(--electric-cyan))]">Back to Sign In</span>
                  </button>
                </div>
              </form>
            ) : (
              ...
              <>
                <form onSubmit={handleAuth} className="space-y-5" noValidate>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      {isLogin && (
                        <button type="button" onClick={() => { setIsForgotPassword(true); setErrors({}); setTouched({}); }}
                          className="text-xs text-[hsl(var(--electric-cyan))] hover:text-[hsl(var(--electric-cyan))] transition-colors hover:underline">
                          Forgot password?
                        </button>
                      )}
                    </div>
                ...
                <Button
                  ...
                  className="w-full h-11 gap-3 border-border/50 bg-background/50 hover:bg-background/80 transition-colors"
                >
                  {isGoogleLoading ? (
