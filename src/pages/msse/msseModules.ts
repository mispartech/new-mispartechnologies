...
export const MSSE_MODULES: MsseModule[] = [
  ...
  { slug: 'attendance/admin',    label: 'Attendance Admin',    icon: ClipboardList,   group: 'Identity & Attendance',   status: 'live', step: 6 },
  { slug: 'security',            label: 'Security Center',     icon: ShieldAlert,     group: 'Identity & Attendance',   status: 'live', step: 4 },
  { slug: 'students',            label: 'Students',            icon: GraduationCap,   group: 'Academic',                status: 'live', step: 5 },
  { slug: 'staff',               label: 'Staff',               icon: Users,           group: 'Academic',                status: 'live', step: 6 },
